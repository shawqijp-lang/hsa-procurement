...
CREATE TABLE production.category_comments (
    id integer DEFAULT nextval('production.category_comments_id_seq'::regclass) NOT NULL,
...
CREATE TABLE production.checklist_templates (
    id integer DEFAULT nextval('production.checklist_templates_id_seq'::regclass) NOT NULL,
    location_id integer NOT NULL,
    category_ar text NOT NULL,
...
CREATE TABLE production.companies (
    id integer DEFAULT nextval('production.companies_id_seq'::regclass) NOT NULL,
...
CREATE TABLE production.daily_checklists (
    id integer DEFAULT nextval('production.daily_checklists_new_id_seq'::regclass) NOT NULL,
    location_id integer NOT NULL,
    user_id integer NOT NULL,
    company_id integer NOT NULL,
...
CREATE TABLE production.dashboard_settings (
    id integer DEFAULT nextval('production.dashboard_settings_id_seq'::regclass) NOT NULL,
    user_id integer NOT NULL,
...
CREATE TABLE production.kpi_access (
    id integer DEFAULT nextval('production.kpi_access_id_seq'::regclass) NOT NULL,
    user_id integer NOT NULL,
...
CREATE TABLE production.locations (
    id integer DEFAULT nextval('production.locations_id_seq'::regclass) NOT NULL,
    name_ar text NOT NULL,
    name_en text NOT NULL,
    icon text NOT NULL,
    description text,
...
CREATE TABLE production.login_attempts (
    id integer DEFAULT nextval('production.login_attempts_id_seq'::regclass) NOT NULL,
...
CREATE TABLE production.master_evaluations (
    id integer DEFAULT nextval('production.master_evaluations_id_seq'::regclass) NOT NULL,
...
CREATE TABLE production.reports (
    id integer DEFAULT nextval('production.reports_id_seq'::regclass) NOT NULL,
    type text NOT NULL,
...
CREATE TABLE production.security_logs (
    id integer DEFAULT nextval('production.security_logs_id_seq'::regclass) NOT NULL,
...
CREATE TABLE production.supervisor_assessment_location_permissions (
    id integer DEFAULT nextval('production.supervisor_assessment_location_permissions_id_seq'::regclass) NOT NULL,
...
CREATE TABLE production.supervisor_user_location_permissions (
    id integer DEFAULT nextval('production.supervisor_user_location_permissions_id_seq'::regclass) NOT NULL,
    supervisor_id integer NOT NULL,
    user_id integer NOT NULL,
    location_id integer NOT NULL,
    granted_by integer NOT NULL,
...
CREATE TABLE production.system_settings (
    id integer DEFAULT nextval('production.system_settings_id_seq'::regclass) NOT NULL,
    user_id integer,
    company_id integer,
...
CREATE TABLE production.unified_evaluations (
    id integer DEFAULT nextval('production.unified_evaluations_id_seq'::regclass) NOT NULL,
    evaluation_id text NOT NULL,
    location_id integer NOT NULL,
    location_name_ar text NOT NULL,
    location_name_en text NOT NULL,
...
CREATE TABLE production.user_dashboard_settings (
    id integer DEFAULT nextval('production.user_dashboard_settings_id_seq'::regclass) NOT NULL,
    user_id integer NOT NULL,
...
CREATE TABLE production.user_location_permissions (
    id integer DEFAULT nextval('production.user_location_permissions_id_seq'::regclass) NOT NULL,
    user_id integer NOT NULL,
    location_id integer NOT NULL,
    created_at timestamp without time zone DEFAULT now()
);
...
CREATE TABLE production.users (
    id integer DEFAULT nextval('production.users_id_seq'::regclass) NOT NULL,
